...
<div class="nav-collapse">
    ...
    <li class="nav-item"><a href="#" ng-click="staffingPatternCtrl.routeTo('nda/2019')"  class="nav-link">NDA</a></li>
    <li class="nav-item"><a href="#" ng-click="staffingPatternCtrl.routeTo('eula/2019')"  class="nav-link">EULA</a></li>
    </ul>
</div>
...
<ul class="navbar-nav navbar-right">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <a class="dropdown-item has-icon text-danger" href="" 
            ...
            document.getElementById('logout-form').submit();" ng-click="staffingPatternCtrl.routeTo('logout')">
...
<div class="container">
    <ul class="navbar-nav">
    <li class="nav-item" ui-sref="dashboard({reportingyear:staffingPatternCtrl.reportingyear})">
...
<a href="submitted-reports.html" class="float" ui-sref="submitted-reports({reportingyear:staffingPatternCtrl.reportingyear})">
