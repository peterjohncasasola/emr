...
<div class="dropdown-menu dropdown-menu-right">
    ...
    <div class="dropdown-divider"></div>
        ...
        <a class="dropdown-item has-icon text-danger" href="" 
            ...
            document.getElementById('logout-form').submit();" ng-click="operationsDeathCtrl.routeTo('logout')"> 
...
<div class="container">
<ul class="navbar-nav">
<li class="nav-item" ui-sref="dashboard({reportingyear:operationsDeathCtrl.reportingyear})">
...
<a href="submitted-reports.html" class="float" ui-sref="submitted-reports({reportingyear:operationsDeathCtrl.reportingyear})">
