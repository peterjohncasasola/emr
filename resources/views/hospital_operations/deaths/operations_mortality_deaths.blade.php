...
<li class="nav-item"><a href="#" ng-click="operationsMortalityDeathCtrl.routeTo('nda/2019')"  class="nav-link">NDA</a></li>
<li class="nav-item"><a href="#" ng-click="operationsMortalityDeathCtrl.routeTo('eula/2019')"  class="nav-link">EULA</a></li>
</ul>
</div>
...
<div class="container">
<ul class="navbar-nav">
<li class="nav-item" ui-sref="dashboard({reportingyear:operationsMortalityDeathCtrl.reportingyear})">
...
<a href="submitted-reports.html" class="float" ui-sref="submitted-reports({reportingyear:operationsMortalityDeathCtrl.reportingyear})">
