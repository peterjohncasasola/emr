...
<li class="nav-item active dropdown">
    ...
    <li class="nav-item dropdown"><a href="#" class="nav-link has-dropdown">Discharges</a>
        ...
        <li class="nav-item" ui-sref="hospital-operations-discharges-er({reportingyear:dischargesERCtrl.reportingyear})"><a href="#" class="nav-link">Ten Leading ER Consultations</a></li>
        <li class="nav-item active" ui-sref="hospital-operations-discharges-testing({reportingyear:dischargesERCtrl.reportingyear})"><a href="#" class="nav-link">Testing and Other Services</a></li>
        ...
        <div class="row">
            ...
            <div class="card card-primary">
                ...
                <div class="card-header-action">
                    <a href="#" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Save</a>
