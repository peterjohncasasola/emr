...
<div class="nav-collapse">
    ...
    <li class="nav-item"><a href="#" ng-click="dischargesSpecialtyCtrl.routeTo('nda/2019')"  class="nav-link">NDA</a></li>
    <li class="nav-item"><a href="#" ng-click="dischargesSpecialtyCtrl.routeTo('eula/2019')"  class="nav-link">EULA</a></li>
    </ul>
</div>
...
<div class="container">
    <ul class="navbar-nav">
    <li class="nav-item" ui-sref="dashboard({reportingyear:dischargesSpecialtyCtrl.reportingyear})">
...
<a href="submitted-reports.html" class="float" ui-sref="submitted-reports({reportingyear:dischargesSpecialtyCtrl.reportingyear})">
...
<form>
    ...
    <div class="modal-body">
        ...
        <div class="modal-footer bg-whitesmoke br">
            <button type="button" class="btn btn-secondary" data-dismiss="modal" ng-click="dischargesSpecialtyCtrl.close()" ui-sref="hospital-operations-discharges-specialty({reportingyear:dischargesSpecialtyCtrl.reportingyear})">Close</button>
