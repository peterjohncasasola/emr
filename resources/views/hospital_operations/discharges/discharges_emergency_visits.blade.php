...
<li class="nav-item"><a href="#" ng-click="dischargesEVCtrl.routeTo('nda/2019')"  class="nav-link">NDA</a></li>
    <li class="nav-item"><a href="#" ng-click="dischargesEVCtrl.routeTo('eula/2019')"  class="nav-link">EULA</a></li>
</ul>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
    ...
    <div class="dropdown-divider"></div>
        ...
        <a class="dropdown-item has-icon text-danger" href="" 
            ...
            document.getElementById('logout-form').submit();" ng-click="dischargesEVCtrl.routeTo('logout')"> 
...
<div class="container">
<ul class="navbar-nav">
<li class="nav-item" ui-sref="dashboard({reportingyear:dischargesEVCtrl.reportingyear})">
...
<a href="submitted-reports.html" class="float" ui-sref="submitted-reports({reportingyear:dischargesEVCtrl.reportingyear})">
