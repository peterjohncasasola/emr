...
<li class="nav-item"><a href="#" ng-click="operationsHAICtrl.routeTo('nda/2019')"  class="nav-link">NDA</a></li>
<li class="nav-item"><a href="#" ng-click="operationsHAICtrl.routeTo('eula/2019')"  class="nav-link">EULA</a></li>
</ul>
</div>
...
<div class="dropdown-menu dropdown-menu-right">
    ...
    <div class="dropdown-divider"></div>
        ...
        <a class="dropdown-item has-icon text-danger" href="" 
            ...
            document.getElementById('logout-form').submit();" ng-click="operationsHAICtrl.routeTo('logout')">
...
<div class="container">
<ul class="navbar-nav">
<li class="nav-item" ui-sref="dashboard({reportingyear:operationsHAICtrl.reportingyear})">
...
<a href="submitted-reports.html" class="float" ui-sref="submitted-reports({reportingyear:operationsHAICtrl.reportingyear})">
...
<script type="text/ng-template" id="add-operation-hai-modal">
    ...
    <div class="modal-body">
        ...
        <div class="modal-footer bg-whitesmoke br">
            <button type="button" class="btn btn-secondary" data-dismiss="modal" ng-click="operationsHAICtrl.close()" ui-sref="hospital-operations-hai({reportingyear:operationsHAICtrl.reportingyear})">Close</button>
