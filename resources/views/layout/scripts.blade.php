...
<script src="{{asset('js/controllers/dischargeser.ctrl.js')}}"></script>
<script src="{{asset('js/controllers/dischargesopd.ctrl.js')}}"></script>
...
<script src="{{asset('js/services/dischargeser.srvcs.js')}}"></script>
<script src="{{asset('js/services/dischargesopd.srvcs.js')}}"></script>
...
<script src="{{asset('js/services/ricdlib.srvcs.js')}}"></script>
