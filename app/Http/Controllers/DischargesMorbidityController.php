        ...
        $transaction = DB::transaction(function($field) use($fields){
            // try{
                ...
                if(DischargesMorbidity::count()<10){
                    ...
                    $check_duplicate = DischargesMorbidity::where('icd10code', $fields['icd10code'])->count();
                    if($check_duplicate<=0){
                        ...
                        $discharges_morbidity->reportingyear                    = 2019;
    ...
    public function send_data_doh(){
        ...
        $discharges_morbidity = DB::table('hospoptdischargesmorbidity as dischargesMorbidity')
            ->select(
                ...
                'dischargesMorbidity.icd10code',
                'dischargesMorbidity.icd10category',
                'dischargesMorbidity.reportingyear')->where('reportingyear', 2019)->get();
