        ...
        $transaction = DB::transaction(function($field) use($fields){
            // try{
                ...
                if(MortalityDeath::count()<10){
                    ...
                    $check_duplicate = MortalityDeath::where('icd10code', $fields['icd10code'])->count();
                    if($check_duplicate<=0){
                        ...
                        $mortality_deaths->reportingyear                    = 2019;
    ...
    public function send_data_doh(){
        ...
        $mortality_deaths = DB::table('hospitaloperationsmortalitydeaths as mortalityDeaths')
            ->select(
                ...
                'mortalityDeaths.icd10code',
                'mortalityDeaths.icd10category',
                'mortalityDeaths.reportingyear')->where('reportingyear', 2019)->get();
